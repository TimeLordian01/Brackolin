...
T.Interior = {
	...
	Model="models/valeyardstudios/brackint/pillars.mdl",
	--Interior Portal Location
	Portal = {
	-- Generated by portals debug tool
	pos = Vector(415, 0, 37.5),
	ang = Angle(-0, 180, 0),
	width = 54,
	height = 82.869278688951,
	thickness = -5.6578568630924,
	inverted = true,
},
 ...
 --    Scanners = {
  --      {
  --          mat = "valeyardstudios/brackolin/interior/roundels/window",
   --         width = 1024,
   --         height = 1024,
   --         ang = Angle(0,0,0),
   --         fov = 75,
...
--    },
	...
	Parts={
		...
		roundelset1 = {},
		roundelset2 = {},
		floor = {ang=Angle(0,90,0)},
		frameset1 = {},
		frameset2 = {},
		frameset3 = {},
		frameset4 = {},
		roof = {ang=Angle(0,90,0)},
		screen = {ang=Angle(0,90,0)},
		consolebrackolin = {},

		--Control Parts
		manualflight = {ang=Angle(0,90,0)},
		...
		door={
			...
			posoffset = Vector(27.800003051758, 0, -47.272605895996),
...
T.Interior.TextureSets = {
	["normal"] = {
		prefix = "valeyardstudios/texturesets/normal/",
				{"roundelinteriordoors", 0},
				{"roundelset1", 0},
				{"roundelset2", 0},
				{"roof", 0},
	...
	["poweroff"] = {
		prefix = "valeyardstudios/texturesets/off/",
				{"roundelinteriordoors", 4},
				{"roundelset1", 4},
				{"roundelset2", 4},
				{"roof", 1},
	},
	["warning"] = {
		prefix = "valeyardstudios/texturesets/warn/",
				{"roundelinteriordoors", 1},
				{"roundelset1", 1},
				{"roundelset2", 1},
				{"roof", 2},
	},
